...
export MAC_CLIENT_ENV="$HOME/.config/panewire/pilot-mac-a.env"
export NCP_CLIENT_ENV="$HOME/.config/panewire/pilot-ncp.env"
chmod 600 "$ADMIN_ENV"
panewire enroll-machine --admin-env "$ADMIN_ENV" --machine-id mac-a --out "$MAC_CLIENT_ENV" --confirm
panewire enroll-machine --admin-env "$ADMIN_ENV" --machine-id ncp-a --out "$NCP_CLIENT_ENV" --confirm
...
scp "$NCP_CLIENT_ENV" "$NCP_HOST:panewire-pilot/ncp-a.env"
ssh "$NCP_HOST" 'chmod 755 "$HOME/panewire-pilot/bin/panewire" && chmod 600 "$HOME/panewire-pilot/ncp-a.env" && stat -c "%a %n" "$HOME/panewire-pilot/bin/panewire" "$HOME/panewire-pilot/ncp-a.env"'
```
...
export NCP_CLIENT_ENV_REMOTE="$HOME/panewire-pilot/ncp-a.env"
